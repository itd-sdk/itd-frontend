import { d, q_1 as b_1, q as q_1, i, a3, u, B } from "./index-BRvFKh3J.js";
import { C } from "./index-CApTjXtl.js";
import { V as V_1 } from "./index-fnKfmOL8.js";
import { I } from "./IconBrand-BDbfkqht.js";
import { I as I_1, a } from "./IconEyeOff-CLBuXicv.js";
const W = "t5oO8-4Z";
const V = "_08esxaRX";
const U = "r8lsLZcX";
const Z = "a-AltNnW";
  ...
  const L = q_1(
    async (a) => {
      ...
      try {
        ...
        if (i(c)) {
          switch (c.code) {
            case a3.ACCOUNT_INVALID_CREDENTIALS: {
              t("Неверный email или пароль");
              break;
            }
            case a3.ACCOUNT_DEACTIVATED: {
              t("Аккаунт деактивирован");
              break;
            }
            case a3.ACCOUNT_TEMPORARILY_LOCKED: {
              t("Аккаунт временно заблокирован. Попробуйте позже");
              break;
            }
            case a3.CAPTCHA_FAILED: {
              t("Проверка captcha не пройдена. Попробуйте снова");
              break;
            }
            case a3.RATE_LIMIT_EXCEEDED: {
              t("Слишком много попыток. Попробуйте позже");
              break;
            }
            case a3.ACCOUNT_EMAIL_DOMAIN_NOT_ALLOWED: {
