import { A as A_1, h, u, c } from "./index-ORJLmKGS.js";
(() => {
  try {
    const e =
    ...
    if (c) {
      ...
      e._sentryDebugIds[c] = "0e0458e8-d186-4803-9347-e7782147ef73";
      e._sentryDebugIdIdentifier =
        "sentry-dbid-0e0458e8-d186-4803-9347-e7782147ef73";
    }
  } catch {}
})();
...
export const AuthLayout = ({ children }) => {
  ...
  h(() => {
    ...
    const k = (i) => {
      ...
      for (let t = 0; t < 2; t++) {
        const s_t = s[t];
        const l = s_t.scrollHeight / 2;
        if (l <= 0) {
          continue;
        }
        const _ = t === 0 ? T[0] + d[0] : T[1] - d[1];
        b[t] = (((b[t] + _ * f) % l) + l) % l;
        const j = t === 0 ? b[t] - l : -b[t];
    ...
    const y = (i) => {
      ...
      d[h] = Math.max(-N, Math.min(N, d[h] - i.deltaY * B));
    };
