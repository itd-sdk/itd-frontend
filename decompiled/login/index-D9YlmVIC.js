import { d, q_1 as b_1, q as q_1, i, a6, u, B } from "./index-BzlbFDoq.js";
import { C } from "./index-CL_c8f_t.js";
import { V as V_1 } from "./index-DRMyxeWT.js";
import { I } from "./IconBrand-sX16mLR6.js";
import { I as I_1, a } from "./IconEyeOff-CeZ2uxwV.js";
const W = "t5oO8-4Z";
const V = "_08esxaRX";
const U = "r8lsLZcX";
const Z = "a-AltNnW";
  ...
  const L = q_1(
    async (a) => {
      ...
      try {
        ...
        if (i(c)) {
          switch (c.code) {
            case a6.ACCOUNT_INVALID_CREDENTIALS: {
              t("Неверный email или пароль");
              break;
            }
            case a6.ACCOUNT_DEACTIVATED: {
              t("Аккаунт деактивирован");
              break;
            }
            case a6.ACCOUNT_TEMPORARILY_LOCKED: {
              t("Аккаунт временно заблокирован. Попробуйте позже");
              break;
            }
            case a6.CAPTCHA_FAILED: {
              t("Проверка captcha не пройдена. Попробуйте снова");
              break;
            }
            case a6.RATE_LIMIT_EXCEEDED: {
              t("Слишком много попыток. Попробуйте позже");
              break;
            }
            case a6.ACCOUNT_EMAIL_DOMAIN_NOT_ALLOWED: {
