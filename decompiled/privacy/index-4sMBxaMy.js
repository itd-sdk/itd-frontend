  ...
  try {
    const i =
      typeof window !== "undefined"
        ...
        ? self
        : {};
    i.SENTRY_RELEASE = { id: "1.1.2" };
    const c = new i.Error().stack;

    if (c) {
      i._sentryDebugIds = i._sentryDebugIds || {};
      i._sentryDebugIds[c] = "a447c8b1-34a7-4f94-9eb9-f99f6a747caf";
      i._sentryDebugIdIdentifier =
        "sentry-dbid-a447c8b1-34a7-4f94-9eb9-f99f6a747caf";
    }
  } catch {}
})();
const t = "vWik";
  ...
  return u_1("div", {
    ...
    children: [
      ...
      u_1("section", {
        ...
        children: [
          ...
          u_1("ul", {
            className: l.list,
            children: [
              u_1("li", { children: "адрес электронной почты;" }),
              u_1("li", { children: "пароль (в зашифрованном виде);" }),
              u_1("li", { children: "имя пользователя и информация профиля;" }),
              u_1("li", {
                children:
          ...
          u_1("ul", {
            className: l.list,
            children: [
              u_1("li", { children: "вид подписки;" }),
              u_1("li", { children: "статус подписки;" }),
              u_1("li", { children: "дата оформления подписки;" }),
              u_1("li", { children: "дата очередного списания;" }),
              u_1("li", {
                children: "сведения о включении и отключении автопродления;",
              }),
              u_1("li", { children: "сумма и статус платежа;" }),
              u_1("li", { children: "идентификатор платежа;" }),
              u_1("li", {
                children:
        ...
        children: [
          ...
          u_1("ul", {
            ...
            children: [
              ...
              u_1("li", { children: "обеспечение функционирования сервиса;" }),
              u_1("li", {
              ...
              u_1("li", { children: "улучшение качества работы сервиса;" }),
              u_1("li", {
                children:
              ...
              u_1("li", { children: "автоматическое продление подписки;" }),
              u_1("li", { children: "обработка возвратов денежных средств;" }),
              u_1("li", {
                children:
        ...
        children: [
          ...
          u_1("ul", {
            ...
            children: [
              ...
              u_1("li", { children: "удалить аккаунт и персональные данные;" }),
              u_1("li", {
      ...
      u_1("section", {
        className: l.section,
        children: [
          u_1("h2", { className: l.sectionTitle, children: "10. Дети" }),
          u_1("p", {
            className: l.text,
            children:
