import { d, q_1 as b_1, q as q_1, i, a4, u, B } from "./index-3JkKRUnj.js";
import { C } from "./index-AYDzWHMv.js";
import { V as V_1 } from "./index-CrT7rloM.js";
  ...
  const L = q_1(
    async (a) => {
      ...
      try {
        ...
        if (i(c)) {
          switch (c.code) {
            case a4.ACCOUNT_INVALID_CREDENTIALS: {
              t("Неверный email или пароль");
              break;
            }
            case a4.ACCOUNT_DEACTIVATED: {
              t("Аккаунт деактивирован");
              break;
            }
            case a4.ACCOUNT_TEMPORARILY_LOCKED: {
