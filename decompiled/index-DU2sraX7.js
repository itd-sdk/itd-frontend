...
import { I } from "./IconCheck-C1c0pK08.js";
const ne = "P3Nv664-";
const oe = "TjFPtUjO";
const se = "FVzwkwHP";
const re = "PUa4FZiJ";
...
const Ae = ({ type: n }) => {
  ...
  return u("div", {
    className: `${r.badge} ${w}`,
    children: a?.icon || u(_, { size: 12 }),
  });
};

const Fe = ({ dateString: n }) => {
  const a = ve(n);
