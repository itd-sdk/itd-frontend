import { a, d, A, q, aq, w, y, $ as $_1, M, m, ar } from "./index-BCnJB3wz.js";
...
(() => {
  try {
    ...
    if (f) {
      ...
      r._sentryDebugIds[f] = "0a845300-3384-4af6-82aa-2726d9395f5a";
      r._sentryDebugIdIdentifier =
        "sentry-dbid-0a845300-3384-4af6-82aa-2726d9395f5a";
    }
  } catch {}
})();
...
function Gt(r, f, B) {
  ...
  const v = q(
    (b = Infinity) => {
      ...
      const M = 32;
      const E = (F.width - M * 2) / f;
      const C = (F.height - M * 2) / B;
      const L = Math.max($, Math.min(E, C, b));
  ...
  const y = q(() => {
    ...
    l(C, i(w_current, C, N.current, F, M));
  }, [r, l, i]);
  ...
  const ot = q(() => {
    ...
    if (L_current) {
      ...
      if (L_current.tool === "line") {
        ...
        e.arc(L_current.start.x, L_current.start.y, q, 0, Math.PI * 2);
      }
  ...
  y(() => {
    ...
    const t = (o) => {
      ...
      if ((o.ctrlKey || o.metaKey) && (o.key === "=" || o.key === "+")) {
        ...
        const a = h.height / 2;
        const Z_current = zoomRef.current;
        const g = Math.min(Q, Z_current + J);
        updateTransform(
          g,
  ...
  y(() => {
    ...
    const o = (e) => {
      ...
      if (e.ctrlKey || e.metaKey) {
        ...
        const s = Math.min(Q, Math.max($, Z_current + g));
        if (s === Z_current) {
          return;
        }
        updateTransform(
  ...
  y(() => {
    ...
    const h = (a) => {
      if (a.touches.length === 2 && pinchRef.current) {
        ...
        const Z_current = zoomRef.current;
        const lt = Math.min(Q, Math.max($, Z_current * H));
        ...
        pinchRef.current = { dist: q, midX: at, midY: U };
      }
    };
