import { d, I as q_1, a, a6 as i_1, a6, $, u, B } from "./index-BzlbFDoq.js";
import { O, C } from "./index-CL_c8f_t.js";
import { I } from "./IconBrand-sX16mLR6.js";
import { I as I_1, a as a_1 } from "./IconEyeOff-CeZ2uxwV.js";
const J = "Gg-jaKhJ";
const Q = "ZErji8sj";
const ee = "ou65Phlx";
const se = "cTITFY-E";
...
export const ForgotPassword = (Ee) => {
      ...
      try {
        ...
        if (i_1(o)) {
          switch (o.code) {
            ...
            case a6.MISSING_FLOW_TOKEN:
            case a6.UNAUTHORIZED: {
  ...
  const U = q_1(async () => {
    ...
    try {
      ...
      if (i_1(t)) {
        if (t.code === a6.RATE_LIMIT_EXCEEDED) {
