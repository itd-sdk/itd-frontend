...
import { A as A_1 } from "./IconNotificationMention-BbO7CDVK.js";
import { A as A_2 } from "./IconCheck-BbDhNxWH.js";
(() => {
  try {
    const e =
    ...
    if (a) {
      ...
      e._sentryDebugIds[a] = "31cb52f2-d723-4383-9bb4-0ae3eae66b31";
      e._sentryDebugIdIdentifier =
        "sentry-dbid-31cb52f2-d723-4383-9bb4-0ae3eae66b31";
    }
  } catch {}
})();
const ne = "WdIW";
...
const H = {
  ...
  post_reaction: {
    badgeColor: "red",
    icon: a(U_1_1_1, { size: 12, filled: true }),
    getAction: (e) =>
...
const _e = ({ type }) => {
  ...
  const p =
    H_e?.badgeColor === "red"
      ? l.red
      : H_e?.badgeColor === "green"
      ? l.green
      : H_e?.badgeColor === "purple"
      ? l.purple
      : l.blue;

  return H_e("div", {
    className: `${l.badge} ${p}`,
    children: H_e?.icon || H_e(g_1, { size: 12 }),
  });
};
        ...
        children: [
          ...
          isVisuallyUnread("div", {
            ...
            children: [
              ...
              isVisuallyUnread("span", {
                className: l.date,
                children: ke(notification.createdAt),
              }),
            ],
          }),
        ],
...
export const Notifications = (e) => {
  ...
  const M = notifications.length === 0 && !x;
              ...
              notifications.map((t) => {
                ...
                return notifications(
                  Fe,
                  {
                    ...
                    onFollowToggle: m,
                    isFollowLoading: o ? k.has(o) : false,
                  },
                  t.id
                );
              }),
