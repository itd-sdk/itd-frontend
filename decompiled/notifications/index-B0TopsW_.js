...
import { a, I } from "./IconNotificationMention-DwO-jf5X.js";
const ne = "P3Nv664-";
const oe = "TjFPtUjO";
const se = "FVzwkwHP";
const re = "PUa4FZiJ";
...
const Z = {
  ...
  post_reaction: {
    badgeColor: "red",
    icon: u(Y_1, { size: 12, filled: true }),
    getAction: (n) =>
      n > 1 ? `и ещё ${n - 1} человек оценили ваш пост` : "оценил(а) ваш пост",
  },
  post_comment: {
    badgeColor: "green",
    icon: u(q_1_1, { size: 12, filled: true }),
...
const Fe = ({ type: n }) => {
  ...
  return u("div", {
    className: `${r.badge} ${w}`,
    children: a?.icon || u(q_1_1, { size: 12 }),
  });
};
...
const Te = ({
  ...
  const F = () => {
    ...
    const q = ["comment_reaction", "comment_reply", "comment_mention"];
