import { d, y, _, T, A, q, a, a4, m } from "./index-DuQT229k.js";
(() => {
  try {
    const t =
    ...
    if (e) {
      ...
      t._sentryDebugIds[e] = "04d146a0-d50e-48ab-9590-708a16a8f805";
      t._sentryDebugIdIdentifier =
        "sentry-dbid-04d146a0-d50e-48ab-9590-708a16a8f805";
    }
  } catch {}
})();
const x = "RKMc";
...
export const EmojiPicker = ({
  ...
  const w = q((c, a) => {
    if (O(c).length > 1) {
      ...
      if (b) {
        const Z = S.left - b.left + S.width / 2;
