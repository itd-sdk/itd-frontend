...
(() => {
  try {
    ...
    if (f) {
      ...
      r._sentryDebugIds[f] = "7c86cb11-eb81-4f30-b087-ba77297f2041";
      r._sentryDebugIdIdentifier =
        "sentry-dbid-7c86cb11-eb81-4f30-b087-ba77297f2041";
    }
  } catch {}
})();
...
function jt(r, f, B) {
  ...
  const y = q_1(() => {
    ...
    l(C, i(w_current, C, N.current, D, M));
  }, [r, l, i]);
  ...
  y(() => {
    ...
    const h = (a) => {
      if (a.touches.length === 2 && pinchRef.current) {
        ...
        const Z_current = zoomRef.current;
        const lt = Math.min(Q, Math.max(K, Z_current * J));
