import { d, I as q_1, a, a3 as i_1, a3, $, u, B } from "./index-BRvFKh3J.js";
import { O, C } from "./index-CApTjXtl.js";
import { I } from "./IconBrand-BDbfkqht.js";
import { I as I_1, a as a_1 } from "./IconEyeOff-CLBuXicv.js";
const J = "Gg-jaKhJ";
const Q = "ZErji8sj";
const ee = "ou65Phlx";
const se = "cTITFY-E";
...
export const ForgotPassword = (Ee) => {
      ...
      try {
        ...
        if (i_1(o)) {
          switch (o.code) {
            ...
            case a3.MISSING_FLOW_TOKEN:
            case a3.UNAUTHORIZED: {
  ...
  const U = q_1(async () => {
    ...
    try {
      ...
      if (i_1(t)) {
        if (t.code === a3.RATE_LIMIT_EXCEEDED) {
