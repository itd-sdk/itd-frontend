const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      ...
      "assets/index-DNQjTkwp.js",
      "assets/index-FLzbuE1s.css",
      "assets/VoiceInput-4bBOMtFF.js",
      "assets/IconPlay-OFjM8Dz9.js",
      "assets/VoiceInput-C3YD_LMG.css",
      "assets/PostMediaVideo-LCCMCZiE.js",
      "assets/PostMediaVideo-DjzembND.css",
      "assets/index-C53vwZxN.js",
      "assets/IconCheckCircle-CZy0eBff.js",
      "assets/index-DHZ40UvI.css",
      "assets/index-DCp7liBX.js",
      "assets/index-CvUzj89i.css",
      "assets/index-Cqhfv-D_.js",
      "assets/index-DVSCV3cb.css",
      "assets/index-DeevoXuW.js",
      "assets/index-DemnVSuW.css",
      "assets/index-CRnoVwYz.js",
      "assets/index-A7yMRbGM.css",
      "assets/index-Bwl-uVj2.js",
      "assets/IconChevronLeft-DL9-Okiv.js",
      "assets/index-Cx_v63nM.css",
      "assets/index-DPVPJAaG.js",
      "assets/index-BvixeCVJ.css",
      "assets/index-ClHBhmeI.js",
      "assets/index-BwqcINxj.css",
      "assets/index-DW4w3Gbh.js",
      "assets/IconCheck-B8U4vchm.js",
      "assets/index-D8jzzTvK.css",
      "assets/index-BhWKQ9dz.js",
      "assets/index-JzN2RmNK.css",
      "assets/index-BlBupwld.js",
      "assets/index-XZUuENeu.css",
      "assets/index-rj0lCnfe.js",
      "assets/index-Cbbj1hwZ.css",
      "assets/index-Da6c7e1E.js",
      "assets/index-Dci8EIGf.css",
      "assets/index-BhFbhNeh.js",
      "assets/index-CxwaLnf5.css",
      "assets/index-7cJeb7U9.js",
      "assets/index-DCG-_DLc.css",
      "assets/index-kAclL5PE.js",
      "assets/index-C3oFuJ10.css",
      "assets/index-DEw5foZJ.js",
      "assets/index-gABdck6x.css",
      "assets/index-DAvPTaMs.js",
      "assets/index-DSK4ItfK.css",
      "assets/index-DitkBGPq.js",
      "assets/index-Dn7bG7QT.css",
      "assets/index-C6zd5az9.js",
      "assets/index-Jz0UtMPL.css",
      "assets/index-B2nJejKT.js",
      "assets/index-BUzgI9M-.css",
      "assets/index-MnUSVhmG.js",
      "assets/index-BP5ArN5c.js",
      "assets/index-Bha8fQqO.css",
      "assets/index-7aCb4nBj.js",
      "assets/index-BTQ1r9m1.css",
      "assets/IconEyeOff-_f-Lat8q.js",
      "assets/index-DVYyKHR-.css",
      "assets/index-CoVL7u1l.js",
      "assets/index-CudG2JWR.css",
      "assets/index-B9PUqt2p.js",
      "assets/index-CLbeNvFG.css",
      "assets/index-Cu-ix4ln.js",
      "assets/index-DvZ46yxk.css",
      "assets/index-DZ5rrhQi.js",
      "assets/index-21OQBOBM.css",
    ])
) => i.map(i => d[i]);
(() => {
  try {
    ...
    if (t) {
      ...
      (e._sentryDebugIds[t] = "7dc33526-857e-4602-934c-629e9af63b77");
      (e._sentryDebugIdIdentifier = "sentry-dbid-7dc33526-857e-4602-934c-629e9af63b77");
    }
  } catch {}
})();
(() => {
...
function So(e) {
  if (((!e.__d && (e.__d = true) && Gt.push(e) && !br.__r++) || Us != Z.debounceRendering)) {
    ((Us = Z.debounceRendering) || Ga)(br);
  }
}
function br() {
  let e;
  ...
  for (d = 0; d < t_length; d++) {
    if ((h = n.__k[d]) != null) {
      ...
      (_ = !!(4 & h.__u)) || p.__k === h.__k
        ? (l = ec(h, l, e, _))
        : typeof h.type == "function" && S !== undefined
        ? (l = S)
        : m && (l = m.nextSibling);
  ...
  e: if (t == "style") {
    ...
    if (n) {
      if (r) {
        ...
        (n.u = Ko);
        e.addEventListener(t, s ? Eo : wo, s);
      }
    } else {
      e.removeEventListener(t, s ? Eo : wo, s);
    }
  } else {
...
function Ot(e) {
  try {
    return !e || typeof e != "function" ? Gr : e.name || Gr;
  } catch {
    return Gr;
  }
}
...
function Pu(...args) {
  ...
  (ie.onerror = function (e, t, n, r, o) {
    ...
    return Yr ? Yr.apply(this, args) : false;
  });
...
function Ou(...args) {
  (Xr = ie.onunhandledrejection);

  (ie.onunhandledrejection = function (e) {
    tt("unhandledrejection", e);
    return Xr ? Xr.apply(this, args) : true;
  });
...
function Ze(e = Hu()) {
  try {
    if (e?.randomUUID) {
      return Dr(() => e.randomUUID()).replace(/-/g, "");
    }
  } catch {}

  if (!Kr) {
    (Kr = `10000000100040008000${100000000000/* 1e11 */}`);
  }

  return Kr.replace(/[018]/g, t => (t ^ ((Vu() & 15) >> (t / 4))).toString(16));
}
function _c(e) {
...
function ju() {
  ...
  return () => (e_timeOrigin + Dr(() => performance.now())) / yc;
}
let Ks;
function St() {
  return (Ks ?? (Ks = ju()))();
...
class ct {
  constructor() {
    ...
    (this._propagationContext = { traceId: Zs(), sampleRand: Tr() });
  }
  clone() {
    const t = new ct();
  ...
  clear() {
    ...
    Js(this, undefined);
    (this._attachments = []);
    this.setPropagationContext({ traceId: Zs(), sampleRand: Tr() });
    this._notifyScopeListeners();
    return this;
  }
  addBreadcrumb(t, n) {
...
function Id(e) {
  ...
  const o = isRemote ? spanId : Br(e).parent_span_id;
  const s = bc(e).scope;
...
function No(e, t, n = Infinity, r = Infinity, o = Zd()) {
  const [s, a] = o;
  if (t == null ||
...
function ef(e) {
  ...
  function o(s) {
    if (typeof r == "string") {
      (r = typeof s == "string" ? r + s : [Ro(r), s]);
    } else {
      r.push(typeof s == "string" ? Ro(s) : s);
    }
  }
  for (const s of n) {
    const [a, c] = s;
...
function nf(e) {
  const t = typeof e.data == "string" ? Ro(e.data) : e.data;
  return [
    {
      type: "attachment",
      length: t.length,
...
function Po(e, t, n, r) {
  ...
  return Kn(s) ? s.then(a => Po(a, t, n, r + 1)) : Po(s, t, n, r + 1);
}
let Ut;
let pi;
let mi;
...
function vf(e, t) {
  ...
  if (e_request?.url && maxValueLength) {
    (e_request.url = Co(e_request.url, maxValueLength));
  }

  if (maxValueLength) {
    e.exception?.values?.forEach((c) => {
      if (c.value) {
        (c.value = Co(c.value, maxValueLength));
      }
    });
  }
}
...
function Jf(e, t, n = Ur()) {
  return Zf(e, t) > n;
}
function Qf(e, { statusCode: t, headers: n }, r = Ur()) {
  const o = { ...e };
...
class sh {
  constructor(t) {
    ...
    if (this._options.enableLogs) {
      Ci(this, "afterCaptureLog", "flushLogs", lh, Ao);
    }
  ...
  _processEvent(t, n, r, o) {
    ...
    return this._prepareEvent(t, n, r, o)
      ...
      if (h === null) {
        ...
        throw eo(`${f} returned \`null\`, will not send event.`);
      }
      ...
      if (c) {
        const S = h.sdkProcessingMetadata?.spanCountBeforeProcessing || 0;
      ...
      if (c && h_transaction_info && h.transaction !== t.transaction) {
        const S = "custom";
        h.transaction_info = { ...h_transaction_info, source: S };
      }
      this.sendEvent(h, n);
      return h;
    })
...
function bh(e, t) {
  return t?.length ? qc(e).some(n => Fr(n, t)) : false;
}
function Ch(e, t) {
  if (!t?.length) {
    return false;
  ...
  return e_transaction ? Fr(e_transaction, t) : false;
}
function Th(e, t) {
  if (!t?.length) {
    return false;
...
function xo(e, t, n, r, o, s, a, c) {
  ...
  if (xt(r[o], Error)) {
    ...
    Oi(u, o, l_length, c);
    (l = xo(e, t, n, r[o], o, [u, ...l], u, l_length));
  }
  ...
  if (Jc(r)) {
    r.errors.forEach((u, f) => {
      if (xt(u, Error)) {
        ...
        const d = e(t, u);
        const l_length = l.length;
        Oi(d, `errors[${f}]`, l_length, c);
        (l = xo(e, t, n, u, o, [d, ...l], d, l_length));
      }
    });
  }
...
const Hh = () => ({
  ...
  setup(e) {
    e.on("spanStart", (t) => {
      ...
      if (o) {
        const { op: op_1, data, description } = Br(t);
...
function Kh(e, t, n, r) {
  ...
  const l = {
    exception: {
      values: [
        {
          type: Mr(t) ? t.constructor.name : r ? "UnhandledRejection" : "Error",
...
function fp() {
  ...
  const t = Di(e, true);
  Fe.document.addEventListener("click", t, false);
  Fe.document.addEventListener("keypress", t, false);

  ["EventTarget", "Node"].forEach((n) => {
    const o = Fe[n]?.prototype;

    if (o?.hasOwnProperty?.("addEventListener")) {
      ze(o, "addEventListener", s => (function(a, c, l) {
      ...
      ze(o, "removeEventListener", s => (function(a, c, l) {
        if (a === "click" || a == "keypress") {
          try {
            const u = this.__sentry_instrumentation_handlers__ || {};
            const u_a = u[a];
...
function gp() {
  Fe.addEventListener("popstate", () => {
    const t = Fe.location.href;
    const n = sr;
    (sr = t);
  ...
  ze(Fe.history, "pushState", e);
  ze(Fe.history, "replaceState", e);
}
function _p(e) {
  try {
    return new URL(e, Fe.location.origin).toString();
  } catch {
    return e;
  }
}
...
function yp(e) {
  ...
  return n && (vr[e] = n.bind(Fe));
}
function vp(e) {
  vr[e] = undefined;
}
const xn = "__sentry_xhr_v3__";
function wp(e) {
  nn("xhr", e);
  rn("xhr", Ep);
}
function Ep() {
  if (!Fe.XMLHttpRequest) {
    return;
  }
  ...
  (XMLHttpRequest_prototype.open = new Proxy(XMLHttpRequest_prototype.open, {
    apply(t, n, r) {
      ...
      (n[xn] = { method: a, url: c, request_headers: {} });
      ...
      const l = () => {
        const n_xn = n[xn];
        if (n_xn && n.readyState === 4) {
          try {
            n_xn.status_code = n.status;
          } catch {}
          const f = {
      ...
      (n.setRequestHeader = new Proxy(n.setRequestHeader, {
        apply(u, f, d) {
          ...
          if (f_xn && Et(p) && Et(h)) {
            (f_xn.request_headers[p.toLowerCase()] = h);
          }
...
const Ap = (e) => {
  ...
  if (n) {
    const [, o, s, a] = n;
    return Fo(o, en, Number(s), Number(a));
  }
  const r = kp.exec(e);
  if (r) {
    ...
    return Fo(a, s, r[3] ? +r[3] : undefined, r[4] ? +r[4] : undefined);
  }
};
...
const Lp = (e) => {
  ...
  if (t) {
    ...
    let o = t[1] || en;
    ([o, r] = sl(o, r));
    return Fo(r, o, t[4] ? +t[4] : undefined, t[5] ? +t[5] : undefined);
  }
};
...
function Gp(e) {
  return n => {
    ...
    const s = Zr(ue.location.href);
    let a = from ? Zr(from) : undefined;
    const c = Zr(to_2);
...
const Jp = (e = {}) => {
  ...
  return {
    ...
    setupOnce() {
      ...
      if (t.setInterval) {
        ze(ue, "setInterval", Ui);
      }

      if (t.requestAnimationFrame) {
        ze(ue, "requestAnimationFrame", Qp);
      }

      if (t.XMLHttpRequest &&
        "XMLHttpRequest" in ue) {
        ze(XMLHttpRequest.prototype, "send", em);
      }
...
function Ui(e) {
  return function (...t) {
    ...
    (t[0] = _n(n, {
      mechanism: {
        handled: false,
        type: `auto.browser.browserapierrors.${Ot(e)}`,
      },
    }));
...
function tm(e, t) {
  ...
  if (r?.hasOwnProperty?.("addEventListener")) {
    ze(r, "addEventListener", o => (function(s, a, c) {
      try {
        if (nm(a)) {
          (a.handleEvent = _n(a.handleEvent, {
              mechanism: {
                data: { handler: Ot(a), target: e },
                handled: false,
    ...
    ze(r, "removeEventListener", o => (function(s, a, c) {
      try {
...
function fm(e) {
  Au((t) => {
    ...
    const o = hm(t);
    const s = Lr(o) ? pm(o) : ps(stackParser, o, undefined, attachStacktrace, true);
    (s.level = "error");
...
(ve.__c = (e, t) => {
  t.some(n => {
    try {
      ...
      (n.__h = n.__h.filter(r => !r.__ || Bo(r)));
    } catch (r) {
      t.some(o => {
        if (o.__h) {
          (o.__h = []);
...
((Vo.prototype = new Ke()).isPureReactComponent = true);
...
((Te.prototype = new Ke()).__c = function (e, t) {
  const t_c = t.__c;
  const r = this;
...
function xm(e) {
  ...
  Vn(nt(Om, { context: t.context }, e.__v), t.v);
}
function Mt(e, t) {
  const n = nt(xm, { __v: e, h: t });
  (n.containerInfo = t);
  return n;
}
...
const oo = { componentStack: null, error: null, eventId: null };
class og extends Ke {
  constructor(t) {
    super(t);
    (this.state = oo);
...
function ug(e, t) {
  ...
  (e.rank = (n => n.props.default ? 0 : Wo(n.props.path).map(dg).join(""))(e));
...
function ws() {
  ...
  je && je.location
    ? je.location
    : je && je.getCurrentLocation
    ? je.getCurrentLocation()
...
const Pl = (e, t) => (n, r, o) => {
  ...
  const m = () => {
    ...
    const _ =
      ((S = s.onRehydrateStorage) == null
        ? undefined
        : S.call(s, (g = r()) != null ? g : p)) || undefined;
    return jo(s_storage.getItem.bind(s_storage))(s.name)
      .then((y) => {
        if (y) {
          if (typeof y.version == "number" && y.version !== s.version) {
            if (s.migrate) {
              const v = s.migrate(y.state, y.version);
              return v instanceof Promise ? v.then(T => [true, T]) : [true, v];
            }
            console.error(
...
const yt = {
  success: (e, t) => Nr.getState().addToast({ type: "success", message: e, duration: t }),
  error: (e, t) => Nr.getState().addToast({ type: "error", message: e, duration: t }),
};
...
class Ol {
  ...
  mapStatusToErrorCode(t) {
    switch (t) {
      ...
      case We.UNPROCESSABLE_ENTITY:
        {
          return le.VALIDATION_ERROR;
        }
      case We.TOO_MANY_REQUESTS:
        {
  ...
  async executeRequest(t, n, r, o, s = false) {
    ...
    try {
      ...
      const S =
        ...
        n.startsWith("/reset-") ||
        n.startsWith("/login/");
      if (g.status === We.UNAUTHORIZED && !s && !S && this.accessToken) {
  ...
  async uploadFormData(t, n, r, o = false) {
    ...
    try {
      ...
      if (f.status === We.UNAUTHORIZED && !o && this.accessToken) {
...
const O = new Ol({ baseURL: "/api", timeout: 30000/* 3e4 */ });
const Ne = new Ol({ baseURL: "/api/v1/auth", timeout: 30000/* 3e4 */ });
...
function Og({
  ...
  const y = () => {
    ...
    let I = C;
    let A = 0;
    for (let N = C; N < e && ((A += g(N) + r), (I = N), !(A >= R)); N++)
      {}
    return { start: Math.max(0, C - n), end: Math.min(e - 1, I + n) };
  };
  ...
  const v = () => {
    ...
    for (let w = start; w <= end; w++) {
      C.push({ index: w, key: o(w), start: S(w) });
    }
    return C;
  };

  if (!h.current) {
    (h.current = new ResizeObserver((b) => {
      let R = false;
      for (const C of b) {
        const C_target = C.target;
        const I = m.current.get(C_target);
        if (I === undefined) {
          continue;
        }
        const A = C.contentRect.height;

        if (A > 0 && d.current.get(I) !== A) {
          d.current.set(I, A);
          (R = true);
        }
      }
  ...
  on(() => {
    ...
    b.addEventListener("scroll", R, { passive: true });
...
const zo = ".jpg,.jpeg,.png,.gif,.webp,.avif,.heic,.heif";
...
const dn = {
  async uploadMedia(e) {
    ...
    t.append("file", e);
    return await O.uploadFormData(L.files.upload, t, { timeout: 300 * 1000/* 1e3 */ });
  },
  async deleteFile(e) {
    await O.delete(L.files.delete(e));
  },
  isValidImageType(e) {
...
const y_ = {
  async getChangelog() {
    const e = await O.get(L.platform.changelog);
    return Array.isArray(e) ? e : e?.data ?? [];
  },
  async getAnnouncements() {
    const e = await O.get(L.platform.announcements);
...
const cr = {
  ...
  async getMyProfile() {
    const e = await O.get(L.users.me);
    return fa(e);
  },
  async updateProfile(e) {
    return await O.put(L.users.updateProfile, e);
  },
  ...
  async _fetchAndCacheProfile(e, t) {
    const n = await O.get(L.users.profile(e));
    const r = fa(n);
    jt.set(t, r);
    return r;
  },
  ...
  async followUser(e) {
    await O.post(L.users.follow(e), {});
  },
  async unfollowUser(e) {
    await O.delete(L.users.follow(e));
  },
  async pinPost(e) {
    await O.post(L.posts.pin(e));
  },
  async unpinPost(e) {
    await O.delete(L.posts.pin(e));
  },
  async getPrivacySettings() {
    const e = await O.get(L.users.privacy);
    return {
  ...
  async updatePrivacySettings(e) {
    ...
    await O.put(L.users.privacy, t);
  },
  async getVerificationStatus() {
    try {
      return await O.get(L.verification.status);
    } catch (e) {
  ...
  async submitVerificationRequest(e) {
    return await O.post(L.verification.submit, { videoUrl: e });
  },
  async getMyPins() {
    const e = await O.get(L.users.pins);
    const t = e.data ?? e;
    return { pins: t.pins ?? [], activePin: t.activePin ?? null };
  },
  async setActivePin(e) {
    await O.put(L.users.setPin, { slug: e });
  },
  async removeActivePin() {
    await O.delete(L.users.setPin);
  },
  async deleteAccount() {
    await O.delete(L.users.deleteAccount);
  },
  async restoreAccount() {
    await O.post(L.users.restoreAccount);
  },
};
function ha(e) {
  const t = e.user ?? e;
...
const Go = {
  async followUser(e) {
    const t = await O.post(L.users.follow(e), {});
    zt.delete(e);
  ...
  async blockUser(e) {
    await O.post(L.users.block(e), {});
    zt.delete(e);
  },
  async unblockUser(e) {
    await O.delete(L.users.block(e));
    zt.delete(e);
  },
  ...
  async batchFollowStatus(e) {
    ...
    return (await O.post(L.users.followStatus, { userIds: e })).data ?? {};
  },
...
function sn({
  ...
  const M = (q) => {
    ...
    (v.current = Date.now());
    (T.current = q.touches[0].clientY);
    const q_target = q.target;
    if (q_target.closest(`.${De.dragHandle}`)) {
      (C.current = true);
      (w.current = true);
      (g.current = true);
  ...
  const he = () => {
    ...
    const q = T.current - y.current;
    const ee = Date.now() - v.current;
    const W = q / ee;

    if (g.current && (q > B_ || W > H_)) {
      R();
    } else if (m.current > 0) {
      A(0, "transform 0.2s ease-out");
      N(0);
  ...
  const de = { onClose: t, isMobile: h, isClosing: S, handleClose: R };
  return i(F_.Provider, {
    value: de,
    children: i("div", {
      ref: f,
      className: `${De.overlay} ${h ? De.mobileOverlay : ""} ${
        S ? De.closing : ""
      }`,
      onMouseDown: E,
      onMouseUp: b,
      children: i("div", {
        ref: d,
        className: `${De.modalWrapper} ${l === "wide" ? De.wide : ""} ${
          h ? De.bottomSheet : ""
        }`,
        style: pe,
        onTouchStart: M,
        ...
        children: [
          s &&
            ...
            i("button", {
              type: "button",
              className: De.externalCloseButton,
              onClick: (q) => {
                q.stopPropagation();
                t();
              },
          ...
          h &&
            i("div", {
              ...
              children: i("div", { className: De.dragIndicator }),
            }),
          i("div", {
            className: `${De.modal} ${s ? De.frameless : ""} ${a || ""} ${
              c || ""
            }`,
            children: [
              !s &&
                ...
                i("div", {
                  className: De.header,
                  children: [
                    i("span", { className: De.title, children: n }),
                    o &&
                      i("button", {
                        type: "button",
...
function hy({ modals: e }) {
  return Mt(
    i(ke, {
      children: e.map(({ id: t, component: n }) => i(Te, { fallback: null, children: n }, t)
      ),
    }),
    document.body
  );
...
const Vy = re(() => Q(() => import("./index-B8wC5jT6.js"), __vite__mapDeps([0, 1, 2, 3])).then(
  e => ({
...
function nr({
  ...
  return i("span", {
    className: `${Be.userName} ${Be[o]} ${s || ""}`,
    children: [
      n
        ? i("span", {
            className: Be.nukstaGlow,
            children: i("span", { className: Be.text, children: e }),
          })
        : i("span", { className: Be.text, children: e }),
      t && i(Qg, {}),
      r &&
        i("span", {
          ref: c,
          className: `${Be.pinWrapper} ${p ? Be.pinClickable : ""}`,
          onMouseEnter: h,
          onMouseLeave: m,
          onClick: p
            ? (g) => {
          ...
          children: [
            ...
            l &&
              Mt(
                i("div", {
                  className: Be.pinTooltip,
                  style: { left: `${l.x}px`, top: `${l.y}px` },
                  children: [
                    i("span", {
                      className: Be.pinTooltipRow,
                      children: [
                        i("span", {
                          className: Be.pinTooltipLabel,
                          children: "Пин:",
                        }),
                        " ",
                        r.name,
                    ...
                    i("span", { className: Be.pinTooltipArrow }),
                  ],
                }),
                document.body
              ),
...
const mt = {
  async register(e) {
    return await Ne.post(L.auth.signUp, e);
  },
  async login(e) {
    return await Ne.post(L.auth.signIn, e);
  },
  async verifyOtp(e) {
    return await Ne.post(L.auth.verifyOtp, e);
  },
  async resendOtp(e) {
    await Ne.post(L.auth.resendOtp, e);
  },
  async refreshSession() {
    return await Ne.post(L.auth.refresh);
  },
  async logout() {
    await Ne.post(L.auth.logout);
  },
  async logoutAll() {
    await Ne.post(`${L.auth.logout}-all`);
  },
  async forgotPassword(e) {
    return await Ne.post(L.auth.forgotPassword, e);
  },
  async resetPassword(e) {
    await Ne.post(L.auth.resetPassword, e);
  },
  async changePassword(e) {
    await Ne.post(L.auth.changePassword, e);
  },
};
function Ft(e, t) {
  if (!e) {
  ...
  Pl(
    (e, t) => {
      O.setRefreshTokenCallback(async () => {
        try {
          const r = await mt.refreshSession();
      ...
      return {
        ...
        resendOtp: async () => {
          ...
          try {
            ...
            const a = Oe(s) ? s.message : "Failed to resend code";
...
const Bt = {
    ...
    async getUnreadCount() {
      return (await O.get(L.notifications.count)).count;
    },
    async markAsRead(e) {
      if (e.length === 1) {
        const r = await O.post(L.notifications.markRead(e[0]));
      ...
      for (let r = 0; r < e.length; r += t) {
        ...
        const s = await O.post(L.notifications.markReadBatch, { ids: o });
        n += s.markedCount ?? s.marked ?? o.length;
      }
      return { markedCount: n };
    },
    async markAllAsRead() {
      const e = await O.post(L.notifications.markAllRead);
      return { markedCount: e.markedCount ?? e.marked ?? 0 };
    },
    async getSettings() {
      const e = await O.get(L.notifications.settings);
      return {
    ...
    async updateSettings(e) {
      ...
      await O.put(L.notifications.settings, t);
    },
  };
          ...
          for (const v of S) {
            if (v.startsWith("event: ")) {
              ...
              try {
                ...
                console.error("SSE message parse error:", T, y);
              }
              (_ = "");
              (y = "");
            }
...
const Le = {
    ...
    async getPost(e) {
      const t = await O.get(L.posts.single(e));
      return Rt(t.data);
    },
    ...
    async likePost(e) {
      await O.post(L.posts.like(e));
    },
    async unlikePost(e) {
      await O.delete(L.posts.like(e));
    },
    async createPost(e) {
      return await O.post(L.posts.create, {
        content: e.text,
        spans: e.spans,
    ...
    async createRepost(e, t) {
      const n = await O.post(L.posts.repost(e), { content: t });
      return Rt(n);
    },
    async getPostsStats(e) {
      ...
      return (await O.post(`${L.posts.list}/stats`, { ids: e })).posts ?? [];
    },
    async editPost(e, t) {
      const n = t.content ?? t.text;
      await O.put(L.posts.update(e), { content: n, spans: t.spans });
    },
    async deletePost(e) {
      await O.delete(L.posts.delete(e));
    },
    async restorePost(e) {
      await O.post(L.posts.restore(e));
    },
    ...
    async votePoll(e, t) {
      const n = await O.post(L.posts.pollVote(e), { optionIds: t });
      return n.data ?? n;
    },
    async unrepost(e) {
      await O.delete(L.posts.repost(e));
    },
  ...
  return {
    ...
    previewReplies:
      e.previewReplies ?? e.replies
        ? (e.previewReplies ?? e.replies).map(Yo)
        : undefined,
    createdAt: e.createdAt,
    editedAt: e.editedAt ?? null,
  };
...
const st = {
    async getComments(e, t = {}) {
      ...
      return { data: a.map(Yo), nextCursor: c };
    },
    ...
    async createComment(e, t, n, r, o) {
      return await O.post(L.posts.comments(e), {
        content: t,
        attachmentIds: o?.map(s => s.mediaId),
      });
    },
    async createReply(e, t, n, r, o) {
      return await O.post(L.comments.replies(e), {
        content: t,
        replyToUserId: r,
        attachmentIds: o?.map(s => s.mediaId),
      });
    ...
    async editComment(e, t, n) {
      await O.patch(L.comments.edit(e), { content: t });
    },
    async deleteComment(e) {
      await O.delete(L.comments.delete(e));
    },
    async likeComment(e) {
      await O.post(L.comments.like(e));
    },
    async unlikeComment(e) {
      await O.delete(L.comments.like(e));
    },
  };
...
const ao = Object.freeze(
  Object.defineProperty(
    { __proto__: null, usePostsStore: ne },
    Symbol.toStringTag,
    { value: "Module" }
  )
);
...
const Pt = ot((e, t) => ({
  ...
  fetchComments: async (n) => {
    const { usePostsStore: r } = await Q(async () => {
        const { usePostsStore: u } = await Promise.resolve().then(() => ao);
  ...
  toggleCommentLike: async (n) => {
    ...
    try {
      ...
      const S = [...t().comments];
      if (s) {
        const _ = S.findIndex(y => y.previewReplies?.some(v => v.id === n)
        );
        if (_ !== -1) {
          const y = S[_].previewReplies.findIndex(v => v.id === n);
          if (y !== -1) {
            const v = [...S[_].previewReplies];
            (v[y] = { ...v[y], reactions: { total: f, myReaction: u } });
            (S[_] = { ...S[_], previewReplies: v });
          }
        }
      } else {
        const _ = S.findIndex(y => y.id === n);

        if (_ !== -1) {
          (S[_] = { ...S[_], reactions: { total: f, myReaction: u } });
        }
      }
      e({ comments: S });
    }
  ...
  addComment: async (
    ...
    try {
        ...
        e(
          s
            ...
            comments: _.comments.map(y => y.id === s
              ? {
                  ...y,
                  previewReplies: [...(y.previewReplies || []), S],
      ...
      const { usePostsStore: d } = await Q(async () => {
          const { usePostsStore: g } = await Promise.resolve().then(() => ao);
...
class Ov {
  ...
  evaluate(t, n) {
    ...
    if (a && !s) {
      ...
      this.enqueue(h, t.postId, kr[t.source]);
    }
  }
  enqueue(t, n, r) {
    this.buffer.push(t);
  ...
  async flush() {
    ...
    O.post(L.posts.dwellLog, r, { headers: o }).catch(() => {});
  }
  flushBeacon() {
    if (this.buffer.length === 0) {
      return;
...
const ba = new Ov();
function xv(e, t, n, r = "", o = undefined) {
  F(() => {
...
function As(e) {
  const t = ne(n => n.postStatsCache[e.id]);
  return (
    t || {
...
const $v = re(() => Q(() => import("./index-DNQjTkwp.js"), __vite__mapDeps([4, 5])).then(
  e => ({
...
const Lv = re(() => Q(() => import("./index-B8wC5jT6.js"), __vite__mapDeps([0, 1, 2, 3])).then(
  e => ({
    default: e.SubscriptionModal
  })
)
...
const Zl = ({
  ...
  return i("a", {
    href: e,
    className: `${$e.navItem} ${u ? $e.active : ""}`,
    onClick: (f) => {
      if (u && o) {
        f.preventDefault();
        o();
    ...
    children: [
      i("span", {
        ...
        children: [
          ...
          r !== undefined &&
            r > 0 &&
            i("span", { className: $e.badge, children: r > 99 ? "99+" : r }),
        ],
      }),
      i("span", { children: n }),
    ],
...
const Mv = () => {
  ...
  const t = ne(T => T.fetchFeed);

  const n = ne(T => T.isRefreshing);

  const r = we(T => T.logout);
  ...
  const y = Se(() => {
    const T = e.url || "/";
    return Ns.some(E => T.startsWith(E));
  }, [e.url]);

  const v = Se(() => {
    const T = e.url || "/";
    return s?.username
      ? T === `/@${s.username}` || T.startsWith(`/@${s.username}/`)
      : false;
  }, [e.url, s?.username]);
  ...
  return y
    ...
    : i("aside", {
        ...
        children: [
          i("div", {
            className: $e.asideTop,
            children: [
              i("div", {
                className: $e.asideBrand,
                children: [
                  i(zg, {}),
                  i("button", {
                    className: $e.asideBrandVersion,
                    onClick: () => f(true),
                    title: "Что нового",
                    children: ["v", "1.1.1"],
                  }),
...
function Os({ variant: e = "medium", delayMs: t = 0 }) {
...
function I0({ count: e = 4 }) {
  return i("div", {
    ...
    children: Array.from({ length: e }, (t, n) => i(Os, { variant: ka[n % ka.length], delayMs: n * 120 }, n)
    ),
  });
}
...
function N0() {
  ...
  const s = k((m, g) => {
    if (g.length <= wt.MAX_POLL_OPTION_LENGTH) {
      r(S => ({
        ...S,
        options: S.options.map(_ => _.id === m ? { ..._, text: g } : _)
      }));
    }
  }, []);
  ...
  const c = k(
    (m) => {
      if (n.options.length > wt.MIN_POLL_OPTIONS) {
        r(g => ({
          ...g,
          options: g.options.filter(S => S.id !== m)
        }));
      }
    },
    [n.options.length]
  ...
  const d = k(() => {
    ...
    const g = n.options.filter(S => S.text.trim().length > 0);
...
function Jl(e = 10, t = false) {
  ...
  const h = k(
    async (v) => {
      const T = dn.isValidVideoType(v);
      const E = dn.isValidImageType(v);
      if (T && !t) {
        yt.error(
          "Загрузка видео доступна только верифицированным пользователям"
        );
      ...
      const C =
        c_current.some(M => M.type === "video") ||
        l_current.some(M => M.type === "video");

      const w =
        c_current.some(M => M.type === "image") ||
        l_current.some(M => M.type === "image");
      ...
      const I = `upload-${Date.now()}-${Math.random().toString(36).slice(2)}`;
      const A = URL.createObjectURL(v);
      const N = T ? "video" : "image";
      s(M => [
        ...M,
        { id: I, file: v, previewUrl: A, progress: 0, type: N },
      ]);
      try {
        const M = await dn.uploadMedia(v);

        s(Y => Y.filter(he => he.id !== I));
  ...
  const g = k((v) => {
    r((T) => {
      const E = T.find(b => b.id === v);

      if (E) {
        URL.revokeObjectURL(E.previewUrl);
      }

      return T.filter(b => b.id !== v);
    });
  ...
  const S = k(
    (v) => {
      const T = v.filter(R => t ? dn.isValidMediaType(R) : dn.isValidImageType(R)
      );
      if (T.length === 0) {
        return;
      }
  ...
  const _ = k(
    async (v) => {
      const [T, E] = v.split(",");
      const b = T.match(/:(.*?);/)?.[1] || "image/png";
      const R = atob(E);
      const C = new Uint8Array(R.length);
      for (let A = 0; A < R.length; A++) {
        C[A] = R.charCodeAt(A);
      }
      const w = new Blob([C], { type: b });
      const I = new File([w], `drawing-${Date.now()}.png`, { type: "image/png" });
      h(I);
    },
    [h]
  );
...
function Pw(e) {
  ...
  const n = (r, o) => {
    ...
    if (r.nodeType === Node.ELEMENT_NODE) {
      ...
      let a = null;
      for (const [u, f] of Object.entries(Rr)) {
...
const xw = [
    { type: "bold", icon: xg, title: "Жирный" },
...
const jr = _l((
  ...
  gs(
    ...
    () => ({
      insertText: (x) => {
        ...
        const M_current = M.current;
        const ae = N_current.slice(0, te) + x + N_current.slice(te);

        const Ce = M_current.map(oe => oe.offset >= te
      ...
      (x) => {
        ...
        if (x?.data === " ") {
          ...
          if (j && j.rangeCount > 0) {
            ...
            if (Ce) {
              const oe = Ce.textContent || "";
              if (oe.endsWith(" ")) {
                Ce.textContent = oe.slice(0, -1);
                const Dt = document.createTextNode(" ");
                Ce.parentNode?.insertBefore(Dt, Ce.nextSibling);
  ...
  const W = k(
    (x, U) => {
      ...
      const ae = Aw(j.commonAncestorContainer, Rr[x]);
      if (ae) {
        Ow(ae);
      } else {
        try {
  ...
  return i(ke, {
    children: [
      i("div", {
        ref: m,
        className: `${Me.editor} ${c} ${G ? Me.empty : ""}`,
      ...
      g &&
        Mt(
          i("div", {
            ...
            children: v
              ? i("form", {
                  className: Me.linkForm,
                  onSubmit: fe,
                  children: [
                    i("input", {
                      ref: C,
                      type: "url",
                      className: Me.linkInput,
                      placeholder: "https://...",
                      value: E,
              ...
              : i("div", {
                  ...
                  children: xw.map(({ type: x, icon: U, title: H }) => i(
                    "button",
                    {
                      type: "button",
                      className: Me.button,
...
const nE = "RGE7";
const rE = "ttOR";
const fo = { textInput: tE, entering: nE, sendButton: rE };
const oE = 1000/* 1e3 */;
function sE({
  text: e,
  spans: t,
  ...
  const f = oE - e.length;
  const d = f < 0;
  const p = [fo.textInput, s ? fo.entering : ""].filter(Boolean).join(" ");
  return i("div", {
    className: p,
    children: [
      i("div", {
      ...
      i("button", {
        className: `${ye.circleButton} ${ye.sendButton} ${fo.sendButton} ${
          c ? ye.submitting : ""
        }`,
        onClick: o,
        disabled: c || l || d,
...
const iE = re(() => Q(() => import("./VoiceInput-4bBOMtFF.js"), __vite__mapDeps([6, 7, 8])).then(
  e => ({
...
function eu({
  ...
  const { text: a, spans: c, handleChange: l, reset: u } = Wr();
  const [f, d] = $("text");
  const [p, h] = $(false);
  const [m, g] = $(false);
  const [S, _] = $(false);
  ...
  const se = R.length > 0 || C.length > 0;
  const pe = a.length > 0 || S || se;
  const de = f === "voice";
  const q = 1000/* 1e3 */;
    ...
    children: [
      ...
      !de &&
        ...
        i("div", {
          ...
          children: i(Ql, { images: R, uploadingImages: C, onRemove: A }),
        }),
      i("div", {
...
function Mn({ value: e }) {
  ...
  F(() => {
    ...
    const m = s.map(T => T.char);

    const g = Math.max(h.length, m.length);
    const S = m.join("").padStart(g, " ").split("");
    ...
    const y = h
      ...
      .map((T, E) => {
      const b = S[E] || " ";
      const R = s[E - (g - s.length)];
      return T !== b
        ? (r.current++,
          { char: T, prevChar: b, isAnimating: true, key: r.current })
        : { char: T, prevChar: T, isAnimating: false, key: R?.key ?? E };
    })
  ...
  const s = Se(() => {
    ...
    for (const p of l) {
      if (p.pos > f) {
        ...
        u.push({ text: h, styles: m, url: g, mentionId: S, hashtag: _ });
      }
  ...
  F(() => {
    ...
    const g = () => {
      ...
      a.current.forEach((v, T) => {
        ...
        const b = E < 0.3 ? E / 0.3 : 1;
        const R = v.opacity * b * f.current;
        l_current.beginPath();
...
function Oa({
  ...
  const v = (R) => {
    ...
    const C = Math.abs(R.clientX - g.current.x);
  ...
  return n
    ? i("div", {
        ref: m,
        className: `${An.container} ${s} ${E ? An.hidden : ""} ${
          u ? An.revealing : ""
        }`,
        style: b,
        onPointerDown: y,
        ...
        children: [
          ...
          E && i("canvas", { ref: h, className: An.canvas }),
        ],
      })
    : i("img", {
        src: e,
...
const xa = { photo_open: 1, video_progress: 2 };
const BE = 2000/* 2e3 */;
const HE = 20;
const $a = "dwell_sid";
function VE() {
...
class WE {
  ...
  trackPhotoOpen(t, n, r, o) {
    ...
    this.ensureInit();
    const s = { t: xa.photo_open, v: t, ai: n };
  ...
  async flush() {
    ...
    const n = JSON.stringify({ sid: this.sessionId, e: t });
    const { body: r, headers: o } = await this.maybeCompress(n);
    O.post(L.posts.interactionLog, r, { headers: o }).catch(() => {});
  }
  flushBeacon() {
    if (this.buffer.length === 0) {
      return;
...
const La = re(() => Q(
  () => import("./PostMediaVideo-LCCMCZiE.js"),
...
function xs({ media: e, isFeed: t = false, postVs: n, source: r }) {
  const o = e?.filter(N => N.type === "image") ?? [];

  const s = e?.filter(N => N.type === "video") ?? [];
  ...
  const b = (N) => {
    ...
    const Y = Date.now();
    const he = N.clientX - p.current;
    const se = N.clientX - g.current;
    const pe = Y - S.current;
  ...
  const R = () => {
    if (d.current && Math.abs(_.current) > ho) {
      T();
    }
  ...
  const w = (N, M) => {
    ...
    const he = (W) => {
      ...
      while (D && fe < 4) {
        const G = window.getComputedStyle(D).borderRadius;
        if (G && G !== "0px" && G !== "0%") {
          return G;
        }
        (D = D.parentElement);
    ...
    const ee = (W) => {
      ...
      const G = a_current.querySelectorAll("img")[W];
      if (!G) {
        return null;
      }
      G.scrollIntoView({
  ...
  if (A === 1) {
    if (o.length === 1) {
      ...
      const M =
        N.width && N.height
          ? {
              width: `${Math.round(oS(N.width, N.height, tS, u))}px`,
...
const fS = "MU6s";
const hS = "zTMP";
const mo = { hint: dS, multiline: fS, arrow: hS };
function Xo({ text: e, children: t, className: n, multiline: r }) {
  const o = P(null);
  const [s, a] = $(null);
...
function SS({
  ...
  const S = m && Date.now() - new Date(t).getTime() < g;
        ...
        children: [
          i("div", {
            ...
            children: i("button", {
              ...
              "aria-label": "Нравится",
              children: [
                i(bs, { filled: e, size: h }, e ? "liked" : "not-liked"),
                i(Mn, { value: n }),
              ],
            }),
          }),
          i("button", {
            ...
            children: [i(Dl, { size: h }), i(Mn, { value: o })],
          }),
          i("button", {
            ...
            disabled: f,
            "aria-label": "Репост",
            children: [i(Is, { size: h }), i(Mn, { value: r })],
          }),
        ],
      }),
      i("div", {
        ...
        children: [
            ...
            i(ke, {
              children: [
                i(Xo, {
                  ...
                  children: [
                    i("span", { className: Ae.capturedEmoji, children: a }),
                    i("span", {
          ...
          i("span", {
            className: Ae.views,
            children: [i(e_, { size: h }), i(Mn, { value: s })],
          }),
        ],
      }),
    ],
...
const US = re(() => Q(() => import("./index-C53vwZxN.js"), __vite__mapDeps([11, 12, 13])).then(
  e => ({
...
function su(e, t) {
  ...
  const a = ne(C => C.deletePost);

  const c = ne(C => C.updatePostLike);

  const l = ne(C => C.updatePollVote);

  const u = ne(C => C.updatePollData);
  ...
  const m = k(async () => {
    ...
    try {
      ...
      c(e.id, C ? "love" : null, -w);
      console.error("Failed to toggle like:", I);
    }
  }, [e.id, d, c]);
  ...
  const S = k(
    (C) => {
      ...
      const I = `${window.location.origin}/@${w}/post/${C}`;
  ...
  const _ = k(
    (C) => {
      n(i(US, { targetType: "post", targetId: C, onClose: r }));
    },
    [n, r]
  );
  ...
  const b = k(
    async (C) => {
      ...
      l(e.id, C, w);
      try {
        const I = await Le.votePoll(e.id, [C]);
        if (I) {
          u(e.id, I);
          return I;
        }
      } catch (I) {
        console.error("[Poll] Failed to vote:", I);
  ...
  const R = k(
    async (C) => {
      try {
        const w = await Le.votePoll(e.id, C);
        if (w) {
          u(e.id, w);
          return w;
        }
...
const Ue = {
  ...
  expandButton: YS,
  originalPost: XS,
  originalPostHeader: KS,
  originalPostTime: ZS,
  originalPostText: JS,
  originalPostMedia: QS,
};
...
function t1({ attachments: e, postVs: t, source: n }) {
  const r = Se(() => Or(e), [e]);
  return r.length === 0
    ? null
    : i("div", {
...
function n1({ originalPost: e, source: t }) {
  const n = e1(e.createdAt);
    ...
    children: [
      i("div", {
        ...
        children: [
          ...
          i("span", { className: Ue.originalPostTime, children: n }),
        ],
      }),
      e.text && i("div", { className: Ue.originalPostText, children: e.text }),
      e.attachments &&
        e.attachments.length > 0 &&
        i(t1, { attachments: e.attachments, postVs: e.vs, source: t }),
      i(ou, {
        liked: s,
        reposted: f.reposted,
        likesCount: a,
...
const r1 = re(() => Q(() => import("./index-DCp7liBX.js"), __vite__mapDeps([14, 15])).then(
  e => ({
    default: e.Poll
  })
)
...
const a1 = Vr(
  (
    ...
    const S = ne(me => me.setCurrentPost);

    const _ = ne(me => me.seedPostStats);

    const y = ne(me => me.posts.find(Ve => Ve.id === t.id));
    ...
    const T = As(t);
    const { isFollowing: E, follow: b, unfollow: R } = C_(t.author.id);
    const C = p && v?.id !== t.author.id ? E : undefined;
    ...
    }, [C, t.author.displayName, b, R, m, g]);
    ...
    F(() => {
      ...
      const Ve = Ce ? [t.id, Ce] : t.id;
      Ar.observe(D_current, Ve);

      return () => Ar.unobserve(D_current);
    }, [t.id, Ce]);
    const be = P(null);
    const oe = P(0);
    ...
    const Ct = k(() => {
      S(y ?? t);
      const Ve = t.author.username ?? t.author.id;
      qe(`/@${Ve}/post/${t.id}`);
    }, [t, y, S]);
    ...
    const qr = Se(() => o1(t.author), [t.author]);

    const Ee = Se(() => Or(t.attachments), [t.attachments]);

    const Ie = Se(() => iu(t.attachments), [t.attachments]);

    const Ls = i("div", {
      className: `${Ue.postInner} ${p ? Ue.isFeed : ""} ${r || ""}`,
      children: [
        p &&
          i("a", {
          ...
          children: [
            ...
            i("div", {
              ...
              children: [
                t.text &&
                  i("div", {
                    ...
                    children: [
                      i("div", {
                        ref: z,
                        className: `${Ue.text} ${j ? Ue.collapsed : ""}`,
                ...
                Ee.length > 0 &&
                  i(xs, { media: Ee, isFeed: p, postVs: t.vs, source: c }),
                Ie &&
                  i(Te, {
                    fallback: null,
                    children: i(r1, {
                ...
                t.originalPost &&
                  i(n1, { originalPost: t.originalPost, source: c }),
                i(ou, {
                  liked: w,
                  reposted: T.reposted,
                  likesCount: I,
...
const O1 = re(() => Q(() => import("./index-Cqhfv-D_.js"), __vite__mapDeps([16, 7, 17])).then(
  e => ({
...
const x1 = Vr((
  ...
  return i("div", {
    className: `${ce.comment} ${b ? ce.small : ""}`,
    children: [
      !S &&
        i("a", {
          href: C,
      ...
      i("div", {
        ...
        children: [
          ...
          s
            ...
            {
              fallback: null,
              children: i(O1, { src: w.url, duration: w.duration }),
            },
            w.id
          )
            ),
...
const au = Vr((
  ...
  const v = m === t.id;
  const T = t.stats.replies > y.length;
  ...
  return i("div", {
    ...
    children: [
      E.map((b, R) => {
        const w = !(R === E.length - 1 && !S && !T);
        const I = m === b.data.id;
        return i(
          "div",
          {
            "data-comment-id": b.data.id,
            className: `${ce.threadItem} ${I ? "flash-highlight" : ""}`,
            children: [
              i("div", {
          ...
          children: [
            i("div", {
              ...
              children: [
                ...
                T && i("div", { className: ce.threadLine }),
              ],
            }),
            i("div", {
              className: ce.commentBody,
...
function $1({
  ...
  const { startIndex: g, endIndex: S } = Se(() => {
    if (e === 0 || c === 0) {
  ...
  const _ = Se(() => {
    ...
    const E = [];
    for (let b = g; b <= S; b++) {
      E.push({ index: b, key: r(b), start: h(b), size: p(b) });
    }
    return E;
  }, [g, S, r, h, p, e]);
  ...
  return { containerRef: T, virtualItems: _, totalSize: m, measureElement: y };
}
const L1 = "Xc4K";
const M1 = "FXzy";
const D1 = "lhDP";
...
const X1 = "Cz31";
const K1 = "AMCt";
const go = { wrapper: Y1, popup: X1, closing: K1 };

const Z1 = re(() => Q(() => import("./index-DeevoXuW.js"), __vite__mapDeps([18, 19])).then(
  e => ({
...
function $s({ onEmojiSelect: e, buttonClassName: t, size: n = 20 }) {
  ...
  const g = k(() => {
    ...
    const A = innerHeight - C.bottom;
    const N = innerWidth - C.left;
    const C_right = C.right;
    const Y = A >= Da + _o ? "bottom" : "top";
    const he = N >= Ma || N > C_right ? "left" : "right";
    let se;
    let pe;
    ...
    children: [
      ...
      r &&
        ...
        Mt(
          i("div", {
            ref: d,
            className: `${go.popup} ${s ? go.closing : ""}`,
            style: {
              position: "fixed",
              top: c.top,
              left: c.left,
...
const Fa = 2000/* 2e3 */;
function fb({ commentId: e, initialText: t, initialSpans: n = [] }) {
        ...
        i("div", {
          ...
          children: [
            i("div", {
              ...
              children:
                !a &&
                i($s, { onEmojiSelect: v, buttonClassName: Ge.mediaButton }),
            }),
            i("div", {
...
const hb = re(() => Q(() => import("./index-C53vwZxN.js"), __vite__mapDeps([11, 12, 13])).then(
  e => ({
    default: e.ReportModal
  })
)
...
function pb({
  ...
  const I = Pt(D => D.clearHighlightedComment);

  const A = Pt(D => D.loadReplies);

  const N = Pt(D => D.deleteComment);

  const M = Pt(D => D.toggleCommentLike);
  ...
  const he = (D, fe, G, x, U) => {
    S({ commentId: D, username: fe, displayName: G, userId: x, replyId: U });
  };
  ...
  const ee = k(
    (D) => {
      ...
      C(i(fb, { commentId: D, initialText: fe, initialSpans: G }));
    },
    [e, C]
  );
            ...
            children: [
              ...
              r &&
                i("div", {
                  ...
                  children: n && i(Os, { variant: "medium" }),
                }),
            ],
          }),
      !p &&
        i("div", {
          ...
          children: i(eu, {
            onSubmit: (D, fe, G) => c({ text: D, spans: fe, attachments: G }),
            onVoiceSend: l,
          }),
        }),
      E &&
...
const _b = "ah63";
const yb = "vjNL";
const pr = { commentsModal: mb, header: gb, title: _b, content: yb };
function vb({ postId: e, onClose: t }) {
  const n = P(null);
  ...
  const y = k(
    async (v) => {
      ...
      const E = new File([v], T, { type: v.type || "audio/webm" });
      const b = await dn.uploadMedia(E);
...
const wb = re(() => Q(() => import("./index-CRnoVwYz.js"), __vite__mapDeps([20, 21])).then(
  e => ({
...
function cu({
  ...
  return i("div", {
    ...
    children: [
      ...
      i(Ql, { images: v, uploadingImages: T, onRemove: C }),
      i("input", {
        ref: N,
        type: "file",
        accept: ae,
...
const Eb = "mD4I";
const Sb = "tqdV";
const Ba = { createPostModal: Eb, title: Sb };
function bb({ wallOwnerId: e, placeholder: t, onPostCreated: n }) {
  const { closeModal: r } = an();

  const o = we(c => c.profile);

  const s = ne(c => c.createPost);
...
const Ha = 5000/* 5e3 */;
function $b({ postId: e, initialText: t, initialSpans: n = [] }) {
  const { closeModal: r } = an();

  const o = ne(E => E.editPost);
...
function jb({ post: e, onClose: t, onSuccess: n }) {
  const [r, o] = $("");
  const [s, a] = $(false);

  const c = we(d => d.profile);

  const l = ne(d => d.updatePostReposted);

  const u = ne(d => d.prependPost);
...
const zb = () => {
  ...
  const S = ne(w => w.fetchFeed);

  const _ = ne(w => w.isRefreshing);
  ...
  const T = Se(() => {
    const w = m.url || "/";
    return Ns.some(I => w.startsWith(I));
  }, [m.url]);
  ...
  const R = k((w, I = false) => {
    ...
    if (A && h_current) {
      const M = parseFloat(getComputedStyle(h_current).paddingLeft) || 0;

      u({
        width: A.offsetWidth,
        transform: `translateX(${A.offsetLeft - M}px)`,
      });
  ...
  F(() => {
    ...
    const I = h_current.querySelector(`.${He.active}`);
    if (I) {
      const A = p.current.indexOf(I);
  ...
  F(() => {
    ...
    const I = () => {
        const N = h_current.querySelector(`.${He.active}`);
        if (N) {
          const M = p.current.indexOf(N);
  ...
  return T
    ? null
    : i("div", {
        className: He.mobileNavigationWrapper,
        children: [
          i("nav", {
            ref: h,
            ...
            children: [
              i("div", {
                className: `${He.indicator} ${f ? "" : He.indicatorHidden}`,
                style: l,
              }),
              c.map((w, I) => {
                const w_icon = w.icon;
                const N = w.id === "event";
                const M = N && o.active && !!o.url;
                const Y = m.url || "/";
                ...
                return i(
                  ...
                  {
                    href: M ? o.url : w.href,
                    target: M ? "_blank" : undefined,
                    rel: M ? "noopener noreferrer" : undefined,
                    ref: (pe) => {
                      (p.current[I] = pe);
                    ...
                    className: `${He.navItem} ${se ? He.active : ""}`,
                    onClick: (pe) => {
                      if (se && w.id === "feed") {
                        pe.preventDefault();
                        v();
                    ...
                    children: [
                      ...
                      i("span", { className: He.label, children: w.label }),
                    ],
                  },
                  w.id
                );
...
const Yb = "WSPA";
const Xb = "DDSa";
const mr = { badge: qb, red: Gb, green: Yb, blue: Xb };
function Kb({ type: e }) {
  const t =
    e === "like"
      ? mr.red
...
function lC({ children: e }) {
  ...
  return i(cC.Provider, {
    value: { toasts: t, addToast: r, removeToast: o, clearAll: s },
    children: [e, i(uC, { toasts: t, onRemove: o, onClearAll: s })],
  });
}
function uC({ toasts: e, onRemove: t, onClearAll: n }) {
  const [r, o] = $(false);
...
function pC({
  ...
  const _ = (E) => {
    ...
    const b = E.touches[0].clientX - d.current;
    a(b);
  };
    ...
    children: [
      i("div", {
        ...
        children: [
          i(rt, {
            src: e.actorAvatar || "",
            badge: i(Kb, { type: e.notificationType }),
          }),
          i("div", {
...
const TC = { success: Zg, error: qg };
function IC({ id: e, type: t, message: n, onRemove: r }) {
  const [o, s] = $(false);
  const TC_t = TC[t];
  ...
  return i("div", {
    ...
    children: [
      i("span", { className: qt.icon, children: i(TC_t, { size: 20 }) }),
...
function NC() {
  const e = Nr(n => n.toasts);

  const t = Nr(n => n.removeToast);
...
const PC = "zqhY";
const AC = "j1ul";
const gr = { tabs: kC, indicator: RC, button: PC, active: AC };
function OC({
  tabs: e,
  defaultTab: t = 0,
  activeIndex: n,
  ...
  const S = (_, y) => typeof _ == "string" ? `${y}` : _.id;
...
const xC = re(() => Q(() => import("./index-Bwl-uVj2.js"), __vite__mapDeps([22, 23, 24])).then(
  e => ({
...
const MC = "KRFC";
const DC = "kwwP";
const yo = { layout: LC, wrapper: MC, content: DC };
const UC = ["/login", "/register", "/forgot-password", "/verify-email"];
...
const HC = ({ children: e }) => {
  ...
  const s = UC.includes(r);
  const a = FC.includes(r);
  const c = BC.includes(r);
  return s
    ? i(ke, { children: e })
    : i(Rg.Provider, {
        value: { isHidden: n },
        children: i("div", {
          ...
          children: i("div", {
            ...
            children: [
              !a && !(t && c) && (t ? i(zb, {}) : i(Mv, {})),
              !a && !t && i(Hv, {}),
              i("div", { className: yo.content, children: e }),
            ],
          }),
        }),
      });
...
function oT() {
  ...
  F(() => {
    ...
    y_
      ...
      const _ = g.find(y => y?.id && !S.includes(y.id));
...
function aT() {
  const e = ne(t => t.applyStatsUpdates);
  F(() => {
    let t = null;
    let n = Infinity;
    let r = false;
...
const xT = "ZKDV";
const $T = "uDYw";
const vo = { virtualFeed: OT, virtualContent: xT, virtualItem: $T };
function LT({
  posts: e,
  renderPost: t,
  ...
  const S = ne(w => w.highlightedPostId);

  const _ = ne(w => w.clearHighlightedPost);
  ...
  return i("div", {
    ref: f,
    className: vo.virtualFeed,
    children: [
      i("div", {
        className: vo.virtualContent,
        style: { height: `${E}px` },
        children: T.map((w) => {
          const I = e[w.index];
          return I
            ? i(
                ...
                {
                  ref: A => b(A, w.index),
                  className: vo.virtualItem,
                  style: { transform: `translateY(${w.start}px)` },
                  children: t(I, w.index, I.id === p),
                },
                w.key
              )
            : null;
...
const VT = (e) => {
  const t = ne(I => I.posts);

  const n = ne(I => I.activeFeed);

  const r = ne(I => I.isLoading);

  const o = ne(I => I.isLoadingMore);

  const s = ne(I => I.hasMore);

  const a = ne(I => I.error);

  const c = ne(I => I.feedScrollPosition);

  const l = ne(I => I.feedMeasuredHeights);

  const u = ne(I => I.feedRestoreToken);

  const f = ne(I => I.setActiveFeed);

  const d = ne(I => I.fetchFeed);

  const p = ne(I => I.loadMoreFeed);

  const h = ne(I => I.createPost);

  const m = ne(I => I.cacheFeedHeights);

  const g = we(I => I.profile);

  const S = we(I => I.status);

  const _ = P(false);

  const y = Se(() => t.map(I => I.author.id), [t]);

  b_(y);

  F(() => {
    if (S === "authenticated" && t.length === 0 && !r) {
      d();
    }
  }, [n, S]);
  ...
  on(() => {
    ...
    requestAnimationFrame(() => window.scrollTo(0, I));
  }, [u, c]);
  ...
  const E = (I) => {
    const N = ["global", "clan", "following"][I] ?? "global";
  ...
  const w = k(
    (I, A, N) => i(a1, { post: I, isHighlighted: N, source: C }, I.id),
    [C]
  );
...
const WT = re(() => Q(() => import("./index-DPVPJAaG.js"), __vite__mapDeps([25, 26])).then(
  e => ({
...
const jT = re(() => Q(() => import("./index-ClHBhmeI.js"), __vite__mapDeps([27, 23, 28])).then(
  e => ({
    default: e.Hashtag
  })
)
...
const zT = re(() => Q(() => import("./index-DW4w3Gbh.js"), __vite__mapDeps([29, 30, 31])).then(
  e => ({
    default: e.Profile
  })
)
...
const qT = re(() => Q(() => import("./index-BhWKQ9dz.js"), __vite__mapDeps([32, 23, 33])).then(
  e => ({
    default: e.PostPage
  })
)
...
const YT = re(() => Q(() => import("./index-rj0lCnfe.js"), __vite__mapDeps([36, 37])).then(
  e => ({
    default: e.Search
  })
)
...
const XT = re(() => Q(() => import("./index-Da6c7e1E.js"), __vite__mapDeps([38, 23, 39])).then(
  e => ({
...
const KT = re(() => Q(() => import("./index-BhFbhNeh.js"), __vite__mapDeps([40, 23, 41])).then(
  e => ({
    default: e.Terms
  })
)
...
const ZT = re(() => Q(() => import("./index-7cJeb7U9.js"), __vite__mapDeps([42, 23, 43])).then(
  e => ({
    default: e.Privacy
  })
)
...
const JT = re(() => Q(() => import("./index-kAclL5PE.js"), __vite__mapDeps([44, 23, 45])).then(
  e => ({
    default: e.Cookies
  })
)
...
const eI = re(() => Q(() => import("./index-DAvPTaMs.js"), __vite__mapDeps([48, 23, 49])).then(
  e => ({
    default: e.Support
  })
)
...
const tI = re(() => Q(() => import("./index-DitkBGPq.js"), __vite__mapDeps([50, 23, 51])).then(
  e => ({
...
const nI = re(() => Q(() => import("./index-C6zd5az9.js"), __vite__mapDeps([52, 53])).then(
  e => ({
    default: e.Event
  })
)
...
const rI = re(() => Q(() => import("./index-B2nJejKT.js"), __vite__mapDeps([54, 23, 55])).then(
  e => ({
...
const aI = re(() => Q(() => import("./index-Cu-ix4ln.js"), __vite__mapDeps([67, 61, 68])).then(
  e => ({
...
const cI = re(() => Q(() => import("./index-C9DVp60G.js"), []).then(e => ({
  default: e.VerifyEmail
}))
);

const lI = re(() => Q(() => import("./index-DZ5rrhQi.js"), __vite__mapDeps([69, 70])).then(
  e => ({
...
const uI = re(() => Q(() => import("./index-to4bYina.js"), []).then(e => ({
  ...
  return i(lC, {
    children: i(fy, {
      children: i(Yy, {
        ...
        children: [
          i($C, {}),
          n && i(Te, { fallback: null, children: i(WT, {}) }),
          i(NC, {}),
          i(tv, {}),
          i(oT, {}),
          i(HC, {
            children: i(Te, {
              ...
              children: i(Rl, {
                ...
                children: [
                  i(VT, { path: "/" }),
                  i(GT, { path: "/notifications" }),
                  i(oI, { path: "/login" }),
                  i(sI, { path: "/register" }),
                  i(iI, { path: "/forgot-password" }),
                  i(aI, { path: "/reset-password" }),
                  i(cI, { path: "/verify-email" }),
                  i(KT, { path: "/terms" }),
                  i(ZT, { path: "/privacy" }),
                  i(JT, { path: "/cookies" }),
                  i(lI, { path: "/onboarding" }),
                  i(YT, { path: "/search" }),
                  i(jT, { path: "/hashtag/:name" }),
                  i(QT, { path: "/external" }),
                  i(eI, { path: "/support" }),
                  i(XT, { path: "/delete-account" }),
                  i(tI, { path: "/child-safety" }),
                  i(nI, { path: "/event" }),
                  i(uI, { path: "/verification" }),
                  i(rI, { path: "/subscription-terms" }),
                  i(qT, { path: "/:username/post/:postId" }),
                  i(dI, { path: "/:slug" }),
                  i(du, { default: true }),
                ],
              }),
