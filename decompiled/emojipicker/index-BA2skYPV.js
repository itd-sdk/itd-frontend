import { d, A as h_1, l as l_1, T, A, q, u, a8, S } from "./index-B74jCtUp.js";
(() => {
  try {
    const t =
    ...
    if (e) {
      ...
      t._sentryDebugIds[e] = "27ad830d-b20e-48ee-a948-bc68f856f7da";
      t._sentryDebugIdIdentifier =
        "sentry-dbid-27ad830d-b20e-48ee-a948-bc68f856f7da";
    }
  } catch {}
})();
const X = "l8eR";
...
export const EmojiPicker = ({
  ...
  const A = q((i, a) => {
    if (O(i).length > 1) {
      ...
      if (S) {
        const z = T.left - S.left + T.width / 2;
        const J = T.top - S.top - 60;
        f({ emoji: i, x: z, y: J });
      }
      return;
    }
  ...
  return excludeCategories("div", {
    ...
    children: [
      ...
      excludeCategories("div", { className: l.content, ref: G, children: M() }),
